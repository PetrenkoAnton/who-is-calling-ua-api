...
use App\Helpers\CommentFormatters\CICommentFormatter;
use Tests\TestCase;

class CICommentFormatterTest extends TestCase
{
    private CICommentFormatter $commentFormatter;

    public function setUp(): void
    {
        parent::setUp();
        $this->commentFormatter = $this->app->make(CICommentFormatter::class);
    }
